        ...
        <div
            ...
            <nav class="flex items-center gap-5 text-sm">
                <a href="<?= $basePath ?>/events"
                   class="text-slate-700 hover:text-blue-600 transition-colors">
                    Browse
                </a>
                ...
                <?php if ($user): ?>
                    <div class="relative group">
                        ...
                        <div class="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-lg border border-slate-100 py-1 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-150">
