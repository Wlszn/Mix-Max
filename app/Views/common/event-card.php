...
<a href="<?= $basePath ?>/events/<?= $eventId ?>"
    ...
    <div class="relative overflow-hidden aspect-video">
        ...
        <div class="absolute top-3 left-3 flex gap-2">
            <span
                class="bg-blue-600 text-white text-[10px] font-bold px-2.5 py-1 rounded-md tracking-wider uppercase shadow-lg">
                Featured
            </span>
        </div>
    ...
    <div class="p-5">
        ...
        <div class="space-y-2 text-sm text-slate-600">
            ...
            <?php if (!empty($venueName)): ?>
                <div class="flex items-center gap-2">
                    <span>📍</span>
                    <span><?= htmlspecialchars($venueName) ?><span class="text-slate-400">,
                            <?= htmlspecialchars($city) ?></span></span>
                </div>
            <?php endif; ?>
        </div>
        ...
        <div class="mt-6 pt-4 border-t border-slate-50 flex items-center justify-between">
            ...
            <span
                class="bg-slate-100 group-hover:bg-blue-600 group-hover:text-white text-slate-600 text-xs font-bold py-2 px-4 rounded-lg transition-all">
                Get Tickets
            </span>
        </div>
    </div>
