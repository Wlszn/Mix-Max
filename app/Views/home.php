    ...
    <div class="min-h-screen bg-gray-50">
        <section class="relative overflow-hidden bg-[#0b1020] text-white">
            ...
            <div class="absolute inset-0">
                ...
                <div
                    class="absolute top-16 right-10 w-[520px] h-[520px] bg-purple-700 rounded-full blur-3xl opacity-25">
                </div>
            ...
            <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="relative hidden lg:block">
                        <div
                            class="absolute inset-0 bg-gradient-to-tr from-blue-500 to-purple-600 rounded-[3rem] blur-2xl opacity-30">
                        </div>

                        <div
                            class="relative bg-white/10 border border-white/20 backdrop-blur-xl rounded-[3rem] p-8 shadow-2xl">
                            <div
                                class="relative aspect-square rounded-[2.5rem] bg-gradient-to-br from-slate-950 via-blue-950 to-purple-950 overflow-hidden flex items-center justify-center">
                                ...
                                <!-- Large icon -->
                                <svg class="relative w-72 h-72 text-white drop-shadow-2xl" fill="none"
                                ...
                                <div
                                    class="absolute left-6 bottom-6 bg-white text-slate-950 rounded-2xl p-4 shadow-xl w-56">
                                    <p class="text-xs uppercase tracking-wide text-slate-500 font-semibold">Featured
                                        Event</p>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <?php foreach ($categories as $category): ?>
                        <?php require __DIR__ . '/common/category-button.php'; ?>
                    <?php endforeach; ?>
                </div>
            </div>
        </section>
